...
tags:
  ...
  - "testing"
  - "convention"
description: "오픈소스에 기여하려고 코드를 작성하다 보면, 생각보다 자주 이런 착각을 하게 됩니다. “이 기능만 잘 만들면 되지 않을까?” 물론 기능은 중요합니다. 컴파일이 되어야 하고, 테스트가 통과해야 하고, 실제로 문제를 해결해야 합니다. 그런데 Apache SeaTunnel의 MQTT"
---
