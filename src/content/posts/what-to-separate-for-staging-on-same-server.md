...
tags:
  ...
  - "aws"
  - "devops"
description: "한 EC2에서 production과 staging을 함께 운영하려면 무엇을 분리해야 할까요? 컨테이너 이름, 호스트 포트, 볼륨, 이미지 태그의 역할을 배포 흐름을 따라 정리합니다."
---
...
한 EC2에서 production과 staging을 함께 실행하는 배포 작업을 검토했습니다. 처음에는 Docker 이미지의 `latest` 태그가 가장 큰 문제처럼 보였습니다.
