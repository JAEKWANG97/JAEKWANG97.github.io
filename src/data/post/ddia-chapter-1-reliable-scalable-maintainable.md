...
예를 들어 제가 만들던 번역 검수 도우미에서는 프로젝트별 Excel에서 추출해 누적한 154만 쌍의 번역 지식 데이터를 조회해야 했습니다. 개별 프로젝트 Excel은 최대 약 20만 행 수준이었고, 154만 쌍은 전체 프로젝트를 합친 지식 DB의 규모입니다.
