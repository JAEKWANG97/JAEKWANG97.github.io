...
겉으로 보면 단순한 검색처럼 보입니다. 하지만 답을 만들려면 프로젝트별 Excel 원본에서 추출해 누적한 **154만 쌍의 번역 기록**을 뒤져야 했습니다.
...
154만 쌍은 Excel 파일 하나의 행 수가 아니라 전체 프로젝트에서 누적한 번역 기록입니다. 개별 프로젝트의 Excel은 최대 약 20만 행 수준이었습니다.
